...
import os,sys,demjson,json,socket
...
print('执行下面的多线程......................................................，最后工作环节..')


with open('self_chat_other_manage.txt','r')as f:
    all_login_ID=f.read()
    f.close()
...
class multi_thread:
    ...
    def start_chat(self):
        ...
        for i in range(0, len(all_QQ)):
            ...
            print('这个当前用户是:', key)
            i = threading.Thread(target=self_chat_others, args=(key, value,))
            # i._stop()
            thread.append(i)
        for j in thread:
            j.start()
